		...
		<u-popup :show="catalogShow" overlayStyle="true" zIndex="99999" mode="left" @close="cataClose()"
			...
			<view class="list-parent">
				...
				<scroll-view scroll-y="true" style="height: 1200rpx;" scroll-with-animation="true"
					show-scrollbar="true">
					<u-cell v-for="(item,index) in itemArr" size="large" title="单元格" clickable="true"></u-cell>
				</scroll-view>
