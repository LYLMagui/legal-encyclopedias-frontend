<template>
	...
	<view class="Box" :style="{'margin-top':barHeight+'px'}">
		<!-- <u-popup :show="catalogShow" overlayStyle="true" zIndex="99999" mode="left" @close="cataClose()"
			...
			<view class="list-parent">
				...
				<scroll-view scroll-y="true" style="height: 1200rpx;" scroll-with-animation="true"
					show-scrollbar="true">
					<u-cell ref="currentChapter" v-for="(item,index) in content_text" size="large" :title="item.title"
						:key="key" clickable="true" @tap="selectChapter(index)"></u-cell>
				</scroll-view>
			</view>
		</u-popup> -->
		<!-- 网页背景开始 -->
		...
		<view class="sview" :style="{color:textColor,fontSize:forUpx(size)+'px',lineHeight:forUpx(lineHeight)+'px'}">
			<view class="law-title">中国人民共和国国立宪法(2023修正)</view>
			<view >
			...
			<view>
				...
				<text class="law-detail-content">全国人民代表大会</text>
			</view>
			<view>
			...
			<view>
				...
				<text class="law-detail-content">2023-03-13</text>
			</view>
			<view>
				<view class="law-detail detailBottom">施行日期</view>:
				<text class="law-detail-content">2023-03-15</text>
			</view>
